package com.rzd.document.service;
...
public class PdfGeneratorService {
    ...
    public byte[] generateContractPdf(OrderDTO order) throws DocumentException, IOException {
        ...
        addText(document, String.format(
                ...
                order.getCompanyName(), order.getInn()
        ), fontNormal);
        ...
        clientCell.addElement(new Paragraph(order.getCompanyName(), fontNormal));
        clientCell.addElement(new Paragraph("ИНН: " + order.getInn(), fontSmall));
        ...
        try {
            ...
            System.out.println("Не удалось добавить подпись");
        }
